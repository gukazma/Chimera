...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        std::cerr << "Usage: " << argv[0] << '\n'
                  ...
                  << "   AKAZE: AKAZE keypoint & floating point descriptor]" << std::endl;

        std::cerr << s << std::endl;
        return EXIT_FAILURE;
    }

    const std::string jpg_filenameL = "DSC00153.JPG";
    const std::string jpg_filenameR = "DSC00154.JPG";
    ...
    matching::DistanceRatioMatch(0.8,
